...
namespace Fall2020_CSC403_Project.item_system
{
    ...
    public class CheetoBoom : AbstractItem, IItem
    {
        ...
        public void ExecuteEffect(FrmLevel frmLevel)
        {
            EffectEvent(frmLevel, global::Fall2020_CSC403_Project.Properties.Resources.wallBoom1,  (int)FrmHome.gameplayForm.enemyCheeto.Position.x, (int)FrmHome.gameplayForm.enemyCheeto.Position.y, "CheetoBoom", 300, 300, 18);
