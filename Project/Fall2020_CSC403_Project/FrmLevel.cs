...
namespace Fall2020_CSC403_Project {
    public partial class FrmLevel : Form {
        ...
        private void FrmLevel_Load(object sender, EventArgs e) {
            ...
            player = new Player(CreatePosition(picPlayer), CreateCollider(picPlayer, PADDING), picPlayer);
            ...
            for (int w = 0; w < NUM_WALLS; w++) {
                ...
                walls[w] = new Entity(CreatePosition(pic), CreateCollider(pic, PADDING), pic);
            }
