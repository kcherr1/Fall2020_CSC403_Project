...
namespace Fall2020_CSC403_Project
{
    public partial class FrmLevel : Form
    {
        ...
        private void Level1()
        {
            ...
            this.terrain.AddItem(new Item("Potion of Strength", MakePictureBox(Resources.speed_potion, new Point(20, 40), itemSize), 10, Item.ItemType.Utility, Item.PotionTypes.Strength));
