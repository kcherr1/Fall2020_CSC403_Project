...
namespace MyGameLibrary.Character
{
    ...
    {
        Dictionary<Items, int> dict1;
        Dictionary<Items, int> dict2;
        Dictionary<Items, int> dict3;
        Dictionary<Items, int> dict4;
        Dictionary<Items, int> dict5;

        public StaticCharacter() {
            declareDict();
            Character Wendy = new Character("Wendy", 40, dict1);
